...
public class CGachaDataSO : ScriptableObject
{
    ...
    [Header("유닛 스파인")]
    public SkeletonDataAsset IllustAsset;       // 레전드 스파인 일러스트
    public SkeletonDataAsset SDAsset;           // 레전드 SD 스파인

    [Header("유닛 스파인 위치 설정")]
    public Vector2 IllustOffset;                // 일러스트 보정 위치
    public float IllustScale = 1f;              // 일러스트 사이즈
}
